...
export const IconLayer = ({ className }: { className?: string }) => (
...
export const IconBrush = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M7.07 14.94c-1.66 0-3 1.35-3 3.02 0 1.33-2.5 1.52-2.5 6.04 0 1.36.68 2 2 2a5.51 5.51 0 0 0 5.5-5.5c0-1.68-1.34-3.02-3-3.02Z" />
  </svg>
);

export const IconAirbrush = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M14.5 5.5l4 4" />
    <path d="M3 13l4 4" />
    <path d="M3 13a7.07 7.07 0 0 1 10-10 7.07 7.07 0 0 1 10 10" />
    <path d="M12.98 11.02a5 5 0 1 1 7.07 7.07" />
    <path d="M13 13v8" />
  </svg>
);
...
export const IconBucket = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
